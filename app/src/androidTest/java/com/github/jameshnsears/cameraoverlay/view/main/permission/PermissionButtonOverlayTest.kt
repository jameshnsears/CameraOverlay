...
class PermissionButtonOverlayTest : PermissionButtonTest() {
    ...
    fun allow() {
        ...
        if (Settings.canDrawOverlays(context)) {
            composeTestRule.setContent {
                PermissionButtonOverlay(ViewModelMainScreen(composeTestRule.activity.application))
            }
    ...
    fun deny() {
        ...
        // enable the button
        val viewModelMainScreen = ViewModelMainScreen(composeTestRule.activity.application)
        val permissionMediatorImplSpy = spyk(PermissionMediatorImpl(composeTestRule.activity.application))
