package com.github.jameshnsears.picturepostcard.view.overlay.window
...
fun View.registerDraggableTouchListener(
    ...
    OverlayWindowHeaderTouchListener(context, this, initialPosition, positionListener)
}

class OverlayWindowHeaderTouchListener(
    context: Context,
